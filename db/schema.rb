...
ActiveRecord::Schema[7.0].define(version: 2022_05_25_031747) do
  create_table "book_store_inventories", force: :cascade do |t|
    ...
    t.index ["book_id"], name: "index_book_store_inventories_on_book_id"
    t.index ["book_store_id"], name: "index_book_store_inventories_on_book_store_id"
  end
  ...
  add_foreign_key "book_store_inventories", "books"
end
